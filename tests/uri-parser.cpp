...
TEST_CASE("URI path parser")
{
    ...
    SECTION("Streams")
    {
...

        {
            ...
            REQUIRE(std::holds_alternative<RestconfStreamRequest::NetconfNotification>(type));
            REQUIRE(std::get<RestconfStreamRequest::NetconfNotification>(type) == RestconfStreamRequest::NetconfNotification::XML);
            REQUIRE(queryParams.empty());
        }

        {
            ...
            REQUIRE(std::holds_alternative<RestconfStreamRequest::NetconfNotification>(type));
            REQUIRE(std::get<RestconfStreamRequest::NetconfNotification>(type) == RestconfStreamRequest::NetconfNotification::JSON);
            REQUIRE(queryParams.empty());
        }
