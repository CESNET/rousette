...
TEST_CASE("NETCONF notification streams")
{
    ...
    SECTION("Invalid parameters")
    {
        ...
        REQUIRE(get("/streams/NETCONF/XML?filter=", {}) == Response{400, plaintextHeaders, "Syntax error in URI querystring at position 7 (position in whole URI: 28): expected filter"});
