    ...
    "error": [
      {
        ...
        {
            REQUIRE(put(RESTCONF_DATA_ROOT "/ietf-system:system-restart", "", {AUTH_DWDM}) == Response{405, {ACCESS_CONTROL_ALLOW_ORIGIN, CONTENT_TYPE_JSON, {"allow", ""}}, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "protocol",
        ...
        "error-message": "'/ietf-system:system-restart' is an RPC/Action node"
            ...
            REQUIRE(put(RESTCONF_DATA_ROOT "/example:tlc/list=eth0/example-action", "", {AUTH_DWDM}) == Response{405, {ACCESS_CONTROL_ALLOW_ORIGIN, CONTENT_TYPE_JSON, {"allow", "OPTIONS, POST"}}, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "protocol",
  ...
  "ietf-restconf:errors": {
    ...
    SECTION("PUT with NMDA")
    {
        ...
        SECTION("Read-only datastores")
        {
            ...
            REQUIRE(put(uri + "/example:top-level-leaf", R"({"example:top-level-leaf": "str"})", {CONTENT_TYPE_JSON, AUTH_ROOT}) == Response{405, {ACCESS_CONTROL_ALLOW_ORIGIN, CONTENT_TYPE_JSON, {"allow", "DELETE, GET, HEAD, OPTIONS, POST, PUT"}}, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
    ...
    "error": [
      {
        ...
        SECTION("Read-only datastores")
        {
            ...
            REQUIRE(post(uri + "/", R"({"example:top-level-leaf": "str"})", {CONTENT_TYPE_JSON, AUTH_ROOT}) == Response{405, {ACCESS_CONTROL_ALLOW_ORIGIN, CONTENT_TYPE_JSON, {"allow", "GET, HEAD, OPTIONS, POST, PUT"}}, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
