...
#define EXPECT_CHANGE_UNORDERED(...) REQUIRE_CALL(dsChangesMock, change((std::vector<SrChange>{__VA_ARGS__}))).TIMES(1)
#define EXPECT_CHANGE(...) EXPECT_CHANGE_UNORDERED(__VA_ARGS__).IN_SEQUENCE(seq1)
