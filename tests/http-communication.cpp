...
TEST_CASE("NACM")
{
  ...
  "nacm-test:unlimited": {
    ...
    srSess.applyChanges();
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/group[.='anonymous']", "");
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='1']/module-name", "nacm-test");
    ...
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='1']/path", "/nacm-test:unlimited/val");
    ...
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='dwdm rule']/rule[name='1']/module-name", "nacm-test");
    ...
    // "anonymous access should be first rule-set and all there should be only read rules followed by deny-all rule")
    // "anonymous first but wrong config (no deny-all)"
    srSess.deleteItem("/ietf-netconf-acm:nacm/rule-list");
    srSess.applyChanges();
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/group[.='anonymous']", "");
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='1']/module-name", "nacm-test");
    ...
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='1']/access-operations", "read");
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='1']/path", "/nacm-test:unlimited/val");
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='2']/module-name", "nacm-test");
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='2']/action", "permit");
    srSess.applyChanges();
    REQUIRE(retrieveData("/nacm-test:*", "dwdm") == std::pair<int, std::string>(200, respAll));
    REQUIRE(retrieveData("/nacm-test:unlimited", "dwdm") == std::pair<int, std::string>(200, respUnlimitedLeaf));
    REQUIRE(retrieveData("/nacm-test:limited", "dwdm") == std::pair<int, std::string>(200, respLimitedLeaf));
    REQUIRE(retrieveData("/nacm-test:*", "restconf-anonymous") == std::pair<int, std::string>(400, "go away"));
    REQUIRE(retrieveData("/nacm-test:unlimited", "restconf-anonymous") == std::pair<int, std::string>(400, "go away"));
    REQUIRE(retrieveData("/nacm-test:limited", "restconf-anonymous") == std::pair<int, std::string>(400, "go away"));
    REQUIRE(retrieveData("/nacm-test:*", std::nullopt) == std::pair<int, std::string>(400, "go away"));
    REQUIRE(retrieveData("/nacm-test:unlimited", std::nullopt) == std::pair<int, std::string>(400, "go away"));
    REQUIRE(retrieveData("/nacm-test:limited", std::nullopt) == std::pair<int, std::string>(400, "go away"));

    // "anonymous first but wrong config (deny-all not last)"
    srSess.deleteItem("/ietf-netconf-acm:nacm/rule-list");
    srSess.applyChanges();
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/group[.='anonymous']", "");
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='1']/module-name", "nacm-test");
    ...
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='2']/module-name", "*");
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='2']/action", "deny");
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='3']/module-name", "nacm-test");
    ...
    srSess.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='3']/path", "/nacm-test:unlimited/val");
    srSess.applyChanges();
    REQUIRE(retrieveData("/nacm-test:*", "dwdm") == std::pair<int, std::string>(200, respAll));
    REQUIRE(retrieveData("/nacm-test:unlimited", "dwdm") == std::pair<int, std::string>(200, respUnlimitedLeaf));
    REQUIRE(retrieveData("/nacm-test:limited", "dwdm") == std::pair<int, std::string>(200, respLimitedLeaf));
