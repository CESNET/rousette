    ...
    "error": [
      {
        ...
        REQUIRE(putData("/example:a", R"({"example:top-level-leaf": "str"}")", {{"x-remote-user", "root"}, {"content-type", "application/yang-data+json"}}) == Response{400, jsonHeaders, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
        ...
        REQUIRE(putData("/example:top-level-list=aaa", R"({"example:top-level-leaf": "a"})", {{"x-remote-user", "root"}, {"content-type", "application/yang-data+json"}}) == Response{400, jsonHeaders, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
  ...
  "example:a": {
    ...
    "example-augment:b": {
      "c": {
        ...
        EXPECT_CHANGE(MODIFIED("/example:l/list[name='netconf']/choice1", "netconf"));
