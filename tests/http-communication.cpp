  ...
  "example:a": {
    ...
    "example-augment:b": {
      "c": {
        ...
        // send wrong keys
        REQUIRE(put("/example:l/list=netconf", R"({"example:list":[{"name": "ahoj", "choice1": "nope"}]})", {AUTH_ROOT, CONTENT_TYPE_JSON}) == Response{400, jsonHeaders, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
    ...
    "error": [
      {
        ...
        REQUIRE(put("/example:l/list=netconf/collection=667", R"({"example:collection":[666]})", {AUTH_ROOT, CONTENT_TYPE_JSON}) == Response{400, jsonHeaders, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
    ...
    "error": [
      {
        ...
        REQUIRE(get("/example:l", {{"x-remote-user", "yangnobody"}, CONTENT_TYPE_JSON}) == Response{200, jsonHeaders, R"({
  "example:l": {
    "list": [
      {
        "name": "libyang",
