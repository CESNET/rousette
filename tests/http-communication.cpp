    ...
    "error": [
      {
        ...
        "error-message": "Wrong URI path format: Couldn't find schema node: /ietf-interfaces:idk"
      }
    ]
  }
}
    ...
    "error": [
      {
        "error-type": "application",
        "error-tag": "operation-failed",
        "error-message": "Wrong URI path format: '/ietf-system:system/radius/server' is not a data resource"
      }
    ]
  }
}
    ...
    "error": [
      {
        "error-type": "application",
        "error-tag": "operation-failed",
        "error-message": "Wrong URI path format: List '/ietf-system:system/radius/server' requires 1 keys"
      }
    ]
  }
}
        ...
        REQUIRE(retrieveData("/ietf-system:set-current-datetime", "dwdm") == Response{400, headers, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
        "error-tag": "operation-failed",
        "error-message": "Wrong URI path format: '/ietf-system:set-current-datetime' is not a data resource"
      }
    ]
  }
}
        ...
        REQUIRE(retrieveData("/ietf-system:set-current-datetime/current-datetime", "dwdm") == Response{400, headers, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
