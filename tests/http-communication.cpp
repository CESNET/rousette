...
TEST_CASE("HTTP")
{
    ...
    srSess.setItem("/ietf-netconf-acm:nacm/groups/group[name='root']/user-name[.='root']", "");
  ...
  "ietf-system:system": {
    ...
    REQUIRE(retrieveData("/ietf-system:system/radius/server", "root") == Response{200, yangJsonRespHeaders, R"({
  "ietf-system:system": {
    "radius": {
      "server": [
        {
