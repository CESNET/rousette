...
bool operator==(const nghttp2::asio_http2::header_value& a, const nghttp2::asio_http2::header_value& b)
{
    return std::tie(a.value, a.sensitive) == std::tie(b.value, b.sensitive);
};
}
