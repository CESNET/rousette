  ...
  "example:a": {
    ...
    "example-augment:b": {
      "c": {
        ...
        REQUIRE_CALL(changeMock, change((std::vector<SrChange>{{sysrepo::ChangeOperation::Created, "/example:top-level-list[name='sysrepo']", std::nullopt}, {sysrepo::ChangeOperation::Created, "/example:top-level-list[name='sysrepo']/name", "sysrepo"}}))).IN_SEQUENCE(seq1).TIMES(1);
        ...
        REQUIRE_CALL(changeMock, change((std::vector<SrChange>{{sysrepo::ChangeOperation::Created, "/example:l/list[name='libyang']", std::nullopt}, {sysrepo::ChangeOperation::Created, "/example:l/list[name='libyang']/name", "libyang"}, {sysrepo::ChangeOperation::Created, "/example:l/list[name='libyang']/choice1", "libyang"}}))).IN_SEQUENCE(seq1).TIMES(1);
        ...
        REQUIRE_CALL(changeMock, change((std::vector<SrChange>{{sysrepo::ChangeOperation::Created, "/example:l/list[name='netconf']", std::nullopt}, {sysrepo::ChangeOperation::Created, "/example:l/list[name='netconf']/name", "netconf"}, {sysrepo::ChangeOperation::Created, "/example:l/list[name='netconf']/choice1", "netconf"}}))).IN_SEQUENCE(seq1).TIMES(1);
        ...
        REQUIRE_CALL(changeMock, change((std::vector<SrChange>{{sysrepo::ChangeOperation::Created, "/example:l/list[name='sysrepo']", std::nullopt}, {sysrepo::ChangeOperation::Created, "/example:l/list[name='sysrepo']/name", "sysrepo"}, {sysrepo::ChangeOperation::Created, "/example:l/list[name='sysrepo']/nested[first='1'][second='2'][third='3']", std::nullopt}, {sysrepo::ChangeOperation::Created, "/example:l/list[name='sysrepo']/nested[first='1'][second='2'][third='3']/first", "1"}, {sysrepo::ChangeOperation::Created, "/example:l/list[name='sysrepo']/nested[first='1'][second='2'][third='3']/second", "2"}, {sysrepo::ChangeOperation::Created, "/example:l/list[name='sysrepo']/nested[first='1'][second='2'][third='3']/third", "3"}, {sysrepo::ChangeOperation::Created, "/example:l/list[name='sysrepo']/choice2", "sysrepo"}}))).IN_SEQUENCE(seq1).TIMES(1);
        ...
        REQUIRE_CALL(changeMock, change(std::vector<SrChange>{{sysrepo::ChangeOperation::Created, "/example:l/list[name='netconf']/collection[.='1']", "1"}, {sysrepo::ChangeOperation::Created, "/example:l/list[name='netconf']/collection[.='2']", "2"}, {sysrepo::ChangeOperation::Created, "/example:l/list[name='netconf']/collection[.='3']", "3"}, {sysrepo::ChangeOperation::Modified, "/example:l/list[name='netconf']/choice1", "snmp"}}));
        ...
        REQUIRE_CALL(changeMock, change(std::vector<SrChange>{{sysrepo::ChangeOperation::Modified, "/example:l/list[name='netconf']/choice1", "netconf"}}));
        REQUIRE(putData("/example:l/list=netconf/choice1", R"({"example:choice1": "netconf"})", {{"x-remote-user", "root"}, {"content-type", "application/yang-data+json"}}) == Response{204, jsonHeaders, ""});

        // add to a leaf-list
        REQUIRE_CALL(changeMock, change(std::vector<SrChange>{{sysrepo::ChangeOperation::Created, "/example:l/list[name='netconf']/collection[.='4']", "4"}}));
        REQUIRE(putData("/example:l/list=netconf/collection=4", R"({"example:collection":[4]})", {{"x-remote-user", "root"}, {"content-type", "application/yang-data+json"}}) == Response{201, jsonHeaders, ""});
