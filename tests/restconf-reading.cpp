    ...
    "error": [
      {
        ...
        REQUIRE(get(RESTCONF_DATA_ROOT "/example:l/list=eth0/example-action", {AUTH_DWDM}) == Response{400, jsonHeaders, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
        ...
        REQUIRE(get(RESTCONF_DATA_ROOT "/example:l/list=eth0/example-action/i", {AUTH_DWDM}) == Response{400, jsonHeaders, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
