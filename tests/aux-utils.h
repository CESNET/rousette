...
void setupRealNacm(sysrepo::Session session)
{
    ...
    session.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='15']/module-name", "ietf-restconf-monitoring");
    ...
    session.setItem("/ietf-netconf-acm:nacm/rule-list[name='anon rule']/rule[name='15']/path", "/ietf-restconf-monitoring:restconf-state/capabilities");
