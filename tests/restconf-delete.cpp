...
TEST_CASE("writing data")
{
  ...
  "ietf-restconf:errors": {
    ...
    SECTION("lists")
    {
        ...
        REQUIRE(httpDelete(RESTCONF_DATA_ROOT "/example:top-level-list=ThisKeyDoesNotExist", {AUTH_ROOT}) == Response{204, noContentTypeHeaders, ""});
  ...
  "ietf-restconf:errors": {
    ...
    SECTION("leaf-lists")
    {
        ...
        REQUIRE(httpDelete(RESTCONF_DATA_ROOT "/example:top-level-leaf-list=666", {AUTH_ROOT}) == Response{204, noContentTypeHeaders, ""});
