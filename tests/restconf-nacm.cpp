...
TEST_CASE("NACM")
{
    ...
    DOCTEST_SUBCASE("no rules")
    {
        ...
        REQUIRE(get(RESTCONF_ROOT "/ietf-system:system", {}) == Response{401, jsonHeaders, R"({
    ...
    "error": [
      {
        ...
        REQUIRE(get(RESTCONF_ROOT "/ietf-system:system", {AUTH_DWDM}) == Response{200, jsonHeaders, R"({
  "ietf-system:system": {
    "contact": "contact",
    "hostname": "hostname",
    "location": "location",
  ...
  "ietf-system:system": {
    ...
    "location": "location"
        ...
        REQUIRE(get(RESTCONF_ROOT "/ietf-interfaces:idk", {}) == Response{400, jsonHeaders, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        ...
        REQUIRE(get(RESTCONF_ROOT "/ietf-system:system/clock", {}) == Response{404, jsonHeaders, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
        ...
        REQUIRE(get(RESTCONF_ROOT "/ietf-system:system/clock/timezone-utc-offset", {}) == Response{404, jsonHeaders, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
      ...
      "server": [
...

        {
            ...
            REQUIRE(clientRequest("GET",
                        RESTCONF_ROOT "/ietf-system:system",
    ...
    "error": [
      {
        ...
        REQUIRE(get(RESTCONF_ROOT "/ietf-interfaces:idk", {AUTH_DWDM}) == Response{400, jsonHeaders, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
  ...
  "ietf-system:system": {
    "clock": {
      "timezone-utc-offset": 2
        ...
        REQUIRE(get(RESTCONF_ROOT "/ietf-system:system/radius/server", {AUTH_NORULES}) == Response{400, jsonHeaders, R"({
  "ietf-restconf:errors": {
    "error": [
      {
        "error-type": "application",
    ...
    REQUIRE(get(RESTCONF_ROOT "/ietf-system:system/radius/server=a", {AUTH_NORULES}) == Response{200, jsonHeaders, R"({
  "ietf-system:system": {
    "radius": {
      "server": [
        {
