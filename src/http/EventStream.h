...
public:
    ...
    EventStream(const nghttp2::asio_http2::server::request& req, const nghttp2::asio_http2::server::response& res, EventSignal& signal, const std::optional<std::string>& initialEvent = std::nullopt);
