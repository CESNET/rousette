...
libyang::DataNode processInternalRPC(sysrepo::Session& sess, const libyang::DataNode& rpcInput, libyang::DataFormat requestEncoding, DynamicSubscriptions& dynamicSubscriptions)
{
    if (rpcInput.findPath("/ietf-subscribed-notifications:establish-subscription")) {
        ...
        dynamicSubscriptions.establishSubscription(rpcInput, *rpcOutput, requestEncoding);
        return *parent;
    }
