...
UriSyntaxError::UriSyntaxError()
    : UriSyntaxError(std::nullopt, std::nullopt)
{
}

UriSyntaxError::UriSyntaxError([[maybe_unused]] const std::optional<unsigned>& position, [[maybe_unused]] const std::optional<std::string>& expectedToken)
