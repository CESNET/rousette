...
const auto uriPrefix = x3::rule<class uriPrefix, URIPrefix>{"uriPrefix"} = (x3::lit("data") >> x3::attr(URIPrefixType::BasicRestconfData) >> x3::attr(boost::none)) | (x3::lit("ds") >> x3::attr(URIPrefixType::NMDADatastore) >> "/" >> fullyQualifiedApiIdentifier);
...
URIPrefix::URIPrefix()
    : resourceType(URIPrefixType::BasicRestconfData)
{
}

URIPrefix::URIPrefix(URIPrefixType resourceType, const boost::optional<ApiIdentifier>& datastore)
