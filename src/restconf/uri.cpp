 ...
 *                       This is useful when we want to parse only e.g. querystring, and report offset of whole URI (incl. path)
 */
...
queryParams::QueryParams parseQueryParams(const std::string& querystring, const unsigned positionOffset)
{
    return parse<queryParams::QueryParams, UriQueryStringSyntaxError>(querystring, queryParamGrammar, positionOffset);
}
