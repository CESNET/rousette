...
const auto subscribedStream = x3::rule<class resources, RestconfStreamRequest::SubscribedNotification>{"subscribedStream"} = x3::lit("/subscribed") >> "/" >> uuid;
...
const auto streamUriGrammar = x3::rule<class grammar, std::variant<RestconfStreamRequest::NetconfNotification, RestconfStreamRequest::SubscribedNotification>>{"streamsGrammar"} =
...
std::optional<std::variant<RestconfStreamRequest::NetconfNotification, RestconfStreamRequest::SubscribedNotification>> parseStreamUri(const std::string& queryString)
{
    std::optional<std::variant<RestconfStreamRequest::NetconfNotification, RestconfStreamRequest::SubscribedNotification>> ret;
