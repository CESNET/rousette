...
const auto streamUriGrammar = x3::rule<class grammar, std::variant<RestconfStreamRequest::NetconfStream, RestconfStreamRequest::SubscribedStream>>{"streamsGrammar"} =
...
std::optional<std::variant<RestconfStreamRequest::NetconfStream, RestconfStreamRequest::SubscribedStream>> parseStreamUri(const std::string& queryString)
{
    std::optional<std::variant<RestconfStreamRequest::NetconfStream, RestconfStreamRequest::SubscribedStream>> ret;
