...
queryParams::QueryParams parseQueryParams(const std::string& input, const unsigned positionOffset = 0);
}
}
...
BOOST_FUSION_ADAPT_STRUCT(rousette::restconf::SseProxyRequest, name);
