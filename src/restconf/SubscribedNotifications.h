...
public:
    ...
    std::shared_ptr<sysrepo::YangPushSubscription> getSubscription(const boost::uuids::uuid uuid) const;

private:
    sysrepo::Session m_session;
    std::map<boost::uuids::uuid, std::shared_ptr<sysrepo::YangPushSubscription>> m_ypSubs;
