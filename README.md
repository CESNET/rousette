...
This access is controlled through NACM as-if the access was made against the `location` leaf within the [`ietf-yang-library`](https://datatracker.ietf.org/doc/html/rfc8525#section-3).
